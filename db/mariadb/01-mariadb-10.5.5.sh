...
if test -d /sources/mariadb-10.5.5
 then
  rm -rf /sources/mariadb-10.5.5
fi
...
tar xf /sources/mariadb-10.5.5.tar.gz -C /sources/ &&

cd /sources/mariadb-10.5.5 &&
...
cmake -DCMAKE_BUILD_TYPE=Release                      \
      ...
      -DINSTALL_DOCDIR=share/doc/mariadb-10.5.5       \
      -DINSTALL_DOCREADMEDIR=share/doc/mariadb-10.5.5 \
