...
if test -d /sources/sqlite-autoconf-3330000
 then
  rm -rf /sources/sqlite-autoconf-3330000
fi
...
tar xf /sources/sqlite-autoconf-3330000.tar.gz -C /sources/ &&

cd /sources/sqlite-autoconf-3330000 &&
