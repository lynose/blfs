...
check_and_download https://archive.mozilla.org/pub/security/nss/releases/NSS_3_64_RTM/src/nss-3.64.tar.gz \
    /sources &&
    
check_and_download http://www.linuxfromscratch.org/patches/blfs/svn/nss-3.64-standalone-1.patch \
    /sources &&

md5sum -c ${SCRIPTPATH}/md5-nss &&

tar xf /sources/nss-3.64.tar.gz -C /sources/ &&

cd /sources/nss-3.64 &&

patch -Np1 -i ../nss-3.64-standalone-1.patch &&
