...
if test -d /sources/libva-2.10.0
 then
  rm -rf /sources/libva-2.10.0
fi

SCRIPT=`realpath $0`
SCRIPTPATH=`dirname $SCRIPT`

check_and_download https://github.com/intel/libva/releases/download/2.10.0/libva-2.10.0.tar.bz2 \
    /sources &&
...
tar xf /sources/libva-2.10.0.tar.bz2 -C /sources/ &&

cd /sources/libva-2.10.0 &&
