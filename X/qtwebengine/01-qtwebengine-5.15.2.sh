...
if test -d /sources/qtwebengine-everywhere-src-5.15.2
 then
  rm -rf /sources/qtwebengine-everywhere-src-5.15.2
fi

SCRIPT=`realpath $0`
SCRIPTPATH=`dirname $SCRIPT`

check_and_download https://download.qt.io/archive/qt/5.15/5.15.2/submodules/qtwebengine-everywhere-src-5.15.2.tar.xz \
        /sources
...
cd /sources/qtwebengine-everywhere-src-5.15.2 &&
