...
if test -d /sources/wireshark-3.4.3
 then
  rm -rf /sources/wireshark-3.4.3
fi

SCRIPT=`realpath $0`
SCRIPTPATH=`dirname $SCRIPT`

check_and_download https://www.wireshark.org/download/src/all-versions/wireshark-3.4.3.tar.xz \
        /sources &&
...
tar xf /sources/wireshark-3.4.3.tar.xz -C /sources/ &&

cd /sources/wireshark-3.4.3 &&
...
as_root install -v -m755 -d /usr/share/doc/wireshark-3.4.3 &&
