...
if test -d /sources/boost_1_75_0
 then
  rm -rf /sources/boost_1_75_0
fi
...
check_and_download https://dl.bintray.com/boostorg/release/1.75.0/source/boost_1_75_0.tar.bz2 \
      /sources


md5sum -c ${SCRIPTPATH}/md5-boost &&

tar xf /sources/boost_1_75_0.tar.bz2 -C /sources/ &&

cd /sources/boost_1_75_0 &&
