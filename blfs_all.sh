...
${log} `basename "$0"` " ======================================" blfs_all &&
./gen-libs/libuv/01-libuv-v1.41.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./X/util-macros/01-util-macros-1.19.3.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./sec/iptables/01-iptables-1.8.7.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./gen-libs/liblinear/01-liblinear-243.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./devel/perl-IO-Socket-SSL/01-perl-IO-Socket-SSL-2.070.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./net/ntp/01-ntp-4.2.8p15.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./devel/perl-URI/01-URI-5.09.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./fsndm/parted/01-parted-3.4.sh &&
${log} `basename "$0"` " ======================================" blfs_all && 
./devel/python-libxml2/01-python-libxml2-2.9.10.sh && 
${log} `basename "$0"` " ======================================" blfs_all &&
./sec/nss/01-nss-3.62.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./sec/make-ca/01-make-ca-1.7.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./devel/Jinja2/01-Jinja2-2.11.3.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./gen/gtk-doc/01-gtk-doc-1.33.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./sec/p11-kit/01-p11-kit-0.23.22.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./fsndm/btrfs-progs/01-btrfs-progs-5.11.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./devel/cmake/01-cmake-3.19.6.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/extra-cmake-modules/01-extra-cmake-modules-5.79.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/plasma-wayland-protocols/01-plasma-wayland-protocols-1.1.1.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./net-libs/c-ares/01-c-ares-1.17.1.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./net-libs/curl/02-curl-7.75.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./gnf-libs/libjpeg-turbo/01-libjpeg-turbo-2.0.6.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./gnf-libs/qpdf/01-qpdf-10.3.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./gnf-libs/jasper/01-jasper-2.0.26.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./gen-libs/clucene/01-clucene-2.3.3.4.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
./clean.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./devel/cbindgen/01-cbindgen-0.18.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./gen-libs/pcre/01-pcre-8.44.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./db/mariadb/01-mariadb-10.5.9.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./fsndm/sshfs/01-sshfs-3.7.1.sh && #TODO ???
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./mld/libsndfile/01-libsndfile-1.0.31.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./mld/sbc/01-sbc-1.5.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./mld/libsamplerate/01-libsamplerate-0.2.1.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./X/Xorg/Xorg-drivers/libva/01-libva-2.10.0.sh && #TODO Rebuild after mesa
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./gnome/gexiv2/01-gexiv2-0.12.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./gen-libs/telepathy-glib/01-telepathy-glib-0.24.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./gen-libs/libical/01-libical-3.0.9.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./sys/bluez/01-bluez-5.56.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./print/cups/01-cups-2.3.3.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./devel/openjdk-bin/01-openjdk-15.0.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./gen-libs/libmbim/01-libmbim-1.24.6.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./gen-libs/libqmi/01-libqmi-1.28.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./sys/ModemManager/01-ModemManager-1.16.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./sys/udisks/01-udisks-2.9.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./gen-libs/libiodbc/01-libiodbc-3.52.14.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./X/gtksourceview/01-gtksourceview-3.24.11.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./X/gtksourceview4/01-gtksourceview-4.8.1.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./mld/gstreamer/01-gstreamer-1.18.3.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./mld/gst-plugins-base/01-gst-plugins-base-1.18.3.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./mld/gst-plugins-ugly/01-gst-plugins-ugly-1.18.3.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./devel/cmake/02-cmake-3.19.6.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./icons/oxygen-icons5/01-oxygen-icons5-5.79.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./gen-libs/qca/01-qca-2.3.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./gen-libs/pinentry/01-pineentry-1.1.1.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./typesetting/install-tl-unx/01-install-tl-unx.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./sec/gnupg/01-gnupg-2.2.27.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./sec/gpgme/02-gpgme-1.15.1.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./mld/pulseaudio/01-pulseaudio-14.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./mld/mlt/01-mlt-6.24.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./mld/v4l-utils/01-v4l-utils-1.20.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./mld/pipewire/01-pipewire-0.3.22.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./audio-utils/mpg123/01-mpg123-1.26.4.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/phonon/01-phonon-4.11.1.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./mld/gst-plugins-good/01-gst-plugins-good-1.18.3.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./devel/lua-5.2/01-lua-5.2.4.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./video-utils/ffmpeg/02-ffmpeg-4.3.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./video-utils/vlc/01-vlc-3.0.12.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./net/NetworkManager/01-NetworkManager-1.30.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./xsoft/firefox/01-firefox-78.8.0.sh &&
./clean.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./gnf-libs/babl/01-babl-0.1.86.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./sys/redland/01-redland-1.0.17.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./sys/cpio/01-cpio-2.13.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./devel/openjdk/01-jdk-15.0.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./gen/ImageMagick/01-ImageMagick-7.0.11-0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./X/Xorg/Xorg-drivers/libevdev/01-libevdev-1.11.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./X/Xorg/Xorg-drivers/xf86-input-evdev/01-xf86-input-evdev-2.10.6.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./X/Xorg/Xorg-drivers/libinput/01-libinput-1.17.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./X/Xorg/Xorg-drivers/xf86-video-intel/01-xf86-video-intel-20210222.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./X/Xorg/Xorg-Legacy/01-Xorg-Legacy.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./video-utils/ffmpeg/02-ffmpeg-4.3.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./net/OpenSSH/02-openssh-8.5p1.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/kf5/01-kf5-5.79.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/falkon/01-falkon-3.1.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/ark/01-ark-20.12.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./icons/breeze-icons/01-breeze-icons-5.79.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/kdenlive/01-kdenlive-20.12.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/kmix/01-kmix-20.12.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/khelpcenter/01-khelpcenter-20.12.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/konsole/01-konsole-20.12.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/libkkexiv2/01-libkexiv2-20.12.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/okular/01-okular-20.12.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/libkdcraw/01-libkdcraw-20.12.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/gwenview/01-gwenview-20.12.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./kde/libkcddb/01-libkcddb-20.12.2.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./xsoft/thunderbird/01-thunderbird-78.8.0.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
...
${log} `basename "$0"` " ======================================" blfs_all &&
./net-libs/libenet/01-libenet.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./gen-libs/libfmt/01-libfmt.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./net-libs/gloox/01-gloox-1.0.24.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./sec/libsodium/01-libsodium.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./net/miniupnp/01-miniupnpc.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
./audio-utils/openal/01-openal.sh &&
${log} `basename "$0"` " ======================================" blfs_all &&
