...
if test -d /sources/Python-3.9.5
 then
  as_root rm -rf /sources/Python-3.9.5
fi

SCRIPT=`realpath $0`
SCRIPTPATH=`dirname $SCRIPT`

check_and_download https://www.python.org/ftp/python/3.9.5/Python-3.9.5.tar.xz \
    /sources &&
...
as_root ln -svfn python-3.9.5 /usr/share/doc/python-3 &&
