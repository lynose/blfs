...
if test -d /sources/openldap-2.4.51
 then
  rm -rf /sources/openldap-2.4.51
fi
...
tar xf /sources/openldap-2.4.51.tgz -C /sources/ &&
...
as_root install -v -dm755 /usr/share/doc/openldap-2.4.51 &&
