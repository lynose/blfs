...
check_and_download https://download.videolan.org/vlc/3.0.12/vlc-3.0.12.tar.xz \
    /sources &&

md5sum -c ${SCRIPTPATH}/md5-vlc &&

tar xf /sources/vlc-3.0.12.tar.xz -C /sources/ &&
...
as_root make docdir=/usr/share/doc/vlc-3.0.12 install &&
