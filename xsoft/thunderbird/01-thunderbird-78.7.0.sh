...
if test -d /sources/thunderbird-78.7.0
 then
  rm -rf /sources/thunderbird-78.7.0
fi

SCRIPT=`realpath $0`
SCRIPTPATH=`dirname $SCRIPT`

check_and_download https://archive.mozilla.org/pub/thunderbird/releases/78.7.0/source/thunderbird-78.7.0.source.tar.xz \
        /sources &&


md5sum -c ${SCRIPTPATH}/md5-thunderbird &&

tar xf /sources/thunderbird-78.7.0.source.tar.xz -C /sources/

cd /sources/thunderbird-78.7.0 &&
