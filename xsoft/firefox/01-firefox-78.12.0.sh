...
if test -d /sources/firefox-78.12.0
 then
  as_root rm -rf /sources/firefox-78.12.0
fi

SCRIPT=`realpath $0`
SCRIPTPATH=`dirname $SCRIPT`

check_and_download https://archive.mozilla.org/pub/firefox/releases/78.12.0esr/source/firefox-78.12.0esr.source.tar.xz \
    /sources &&

md5sum -c ${SCRIPTPATH}/md5-firefox &&

# returns non-zero, ignore
tar xf /sources/firefox-78.12.0esr.source.tar.xz -C /sources/

cd /sources/firefox-78.12.0 &&
